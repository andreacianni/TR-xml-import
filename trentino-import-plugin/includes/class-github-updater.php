<?php
/**
 * GitHub Auto-Updater for Trentino Import Plugin
 * 
...
class TrentinoGitHubUpdater {
    ...
    private $github_repository = 'TR-xml-import';
    private $github_token = '';
    
    /**
     * Cache settings
     */
    private $cache_key = 'trentino_github_updater_cache';
    ...
    private function init_admin() {
        ...
        add_action('wp_ajax_trentino_refresh_github_cache', [$this, 'ajax_refresh_cache']);
    }
    ...
    public function add_admin_menu() {
        add_plugins_page(
            'Trentino Import GitHub Updater',
            'GitHub Updater',
            'manage_options',
            'trentino-github-updater',
            [$this, 'admin_page']
        );
    }
    ...
    public function admin_page() {
        ...
        ?>
        <div class="wrap">
            <h1>Trentino Import Plugin - GitHub Updater</h1>
    ...
    public function admin_enqueue_scripts($hook) {
        if ($hook !== 'plugins_page_trentino-github-updater') {
            return;
        }
            ...
            jQuery(document).ready(function($) {
                $('#refresh-github-cache').on('click', function() {
                    ...
                    $.ajax({
                        ...
                        type: 'POST',
                        data: {
                            action: 'trentino_refresh_github_cache',
                            nonce: '" . wp_create_nonce('trentino_refresh_cache') . "'
                        },
    ...
    public function ajax_refresh_cache() {
        check_ajax_referer('trentino_refresh_cache', 'nonce');
    ...
    public function plugin_action_links($links) {
        $settings_link = sprintf(
            '<a href="%s">%s</a>',
            admin_url('plugins.php?page=trentino-github-updater'),
            __('GitHub Updater')
        );
