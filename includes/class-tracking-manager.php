<?php
/**
 * Trentino Import Plugin - Tracking Manager
 * 
...
class TrentinoTrackingManager {
    
    /**
     * Nome tabella tracking
     */
    const TABLE_NAME = 'trentino_import_tracking';
    ...
    public function __construct() {
        ...
        add_action('trentino_import_create_tables', array($this, 'create_tracking_table'));
    }
    ...
    public function create_tracking_table() {
        ...
        // Salva versione DB
        update_option('trentino_import_db_version', self::DB_VERSION);
