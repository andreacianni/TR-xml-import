<?php
/**
 * Trentino Import Plugin - Chunked Import Engine
 * 
...
class TrentinoChunkedImportEngine {
    ...
    public function __construct() {
        ...
        $this->tracking_manager = new TrentinoTrackingManager();
        $this->streaming_parser = new TrentinoXmlStreamingParser();
        $this->property_mapper = new TrentinoPropertyMapper();
        $this->wp_importer = new TrentinoWpImporter();
    ...
    private function save_import_results($results) {
        update_option('trentino_last_import_results', $results);
        
        // Cleanup progress transient
        delete_transient('trentino_import_progress');
        delete_transient('trentino_import_stop_flag');
    }
    
    /**
     * Utility methods (abbreviated for brevity)
     */
    private function is_property_in_enabled_provinces($property_data) {
        return true; // Simplified for now
    }
    
    private function determine_property_province($property_data) {
        return 'TN'; // Simplified for now
    }
    ...
    public static function get_current_progress() {
        return get_transient('trentino_import_progress');
    }
    
    public static function get_last_import_results() {
        return get_option('trentino_last_import_results');
    }
